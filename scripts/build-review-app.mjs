...
const reviewBank = {
  ...
  oppgaver: bank.oppgaver.map((question) => ({
    ...question,
    hints: question.hint,
    vanskelighetsgrad: ({ 1: "lett", 2: "middels", 3: "vanskelig" })[question.niva],
...
<body>
  ...
  <main>
    <section class="hero"><p class="eyebrow">Kontrollverktøy</p><h1>Se gjennom oppgavene, steg for steg.</h1><p class="lead">Her finner du alle oppgavene fra elevappen, sortert etter tema. Filtrer på eksamensdel og nivå, og åpne en oppgave for å lese hint og fasit. Felles case-tekst vises ved alle tilhørende deloppgaver.</p><div class="summary-row" aria-label="Oppsummering"><span class="summary-chip">${reviewBank.oppgaver.length} oppgaver</span><span class="summary-chip">${reviewBank.oppgaver.reduce((sum, q) => sum + q.hints.length, 0)} hint</span><span class="summary-chip">${reviewBank.groups} Del 2-case</span><span class="summary-chip">${reviewBank.temaer.length} temaer</span></div></section>
